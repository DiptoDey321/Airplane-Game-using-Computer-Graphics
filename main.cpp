...
void drawBg()
{
	...
	glPushMatrix();//sun
      glTranslatef(93, 88, 0);
      glColor3f(252/256.0, 212/256.0, 64/256.0);
      circle(5,6.5);
    glPopMatrix();
...
void welcome()
{
	glColor3f(0.0,0.56,0.0);   //welcome background
	glBegin(GL_POLYGON);
	glVertex3f(0.0,0.0,0.0);
	glColor3f(0.137,0.137,0.556);
	glVertex3f(100.0,0.0,0.0);
	...
	glRectf(40,30,60,35);
	glColor3f(0.137,0.137,0.556);
	drawString(41,31,0,GLUT_BITMAP_HELVETICA_18,"      Instruction");
...
void printScore()
{
	...
	drawString(78,91,0,GLUT_BITMAP_TIMES_ROMAN_10,"Level");
	drawString(78,93,0,GLUT_BITMAP_TIMES_ROMAN_24,slevel);
	...
	drawString(68,91,0,GLUT_BITMAP_TIMES_ROMAN_10,"Distance");
	sprintf(score_Str, "%d m",(int)score );
	drawString(68,93,0,GLUT_BITMAP_TIMES_ROMAN_24, score_Str);
...
void display()
{
	...
	else if (instflag == true)
	{
		...
		drawString(23,57,0,GLUT_BITMAP_HELVETICA_18,"Use the Right mouse key to boost");
		drawString(33,27,0,GLUT_BITMAP_HELVETICA_18,"Enjoy it");
	...
	else if (abtflag == true)
	{
		...
		drawString(21,61,0,GLUT_BITMAP_HELVETICA_18,"  Md Enamul Hasan:  011173013");
		drawString(21,65,0,GLUT_BITMAP_HELVETICA_18,"  Md Monirozzaman: 011162102");
		drawString(21,69,0,GLUT_BITMAP_HELVETICA_18,"  Dipto Dey:              011162111");

		drawString(33,40,0,GLUT_BITMAP_HELVETICA_18," ENJOY THE GAME");
		glutPostRedisplay();
